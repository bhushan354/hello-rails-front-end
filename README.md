...
1. Download or clone this [repostory](git@github.com:bhushan354/hello-rails-front-end.git).
...
- Clone this [repository](git@github.com:bhushan354/hello-rails-front-end.git) to your desired folder:

- Run this command in your command line interface:

```sh
  cd [YOUR FOLDER]
  git git@github.com:bhushan354/hello-rails-front-end.git
